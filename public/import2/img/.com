...
<html dir="ltr" lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <title>www.googleadservices.com</title>
...
<body id="t" class="neterror" style="font-family: &#39;Segoe UI&#39;, Tahoma, sans-serif; font-size: 75%" jstcache="0">
  <div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
    <div id="main-content" jstcache="0">
      ...
      <div id="main-message" jstcache="0">
        ...
        <p jsselect="summary" jsvalues=".innerHTML:msg" jstcache="1"><strong jscontent="hostName" jstcache="22">www.googleadservices.com</strong> took too long to respond.</p>
  ...
  <div id="sub-frame-error" jstcache="0">
    ...
    <div id="sub-frame-error-details" jsselect="summary" jsvalues=".innerHTML:msg" jstcache="1"><strong jscontent="hostName" jstcache="22">www.googleadservices.com</strong> took too long to respond.</div>
  </div>
...
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.
var loadTimeData;class LoadTimeData{constructor(){this.data_=null}set data(value){expect(!this.data_,"Re-setting data.");this.data_=value}valueExists(id){return id in this.data_}getValue(id){expect(this.data_,"No data. Did you remember to include strings.js?");const value=this.data_[id];expect(typeof value!=="undefined","Could not find value for "+id);return value}getString(id){const value=this.getValue(id);expectIsType(id,value,"string");return value}getStringF(id,var_args){const value=this.getString(id);if(!value){return""}const args=Array.prototype.slice.call(arguments);args[0]=value;return this.substituteString.apply(this,args)}substituteString(label,var_args){const varArgs=arguments;return label.replace(/\$(.|$|\n)/g,(function(m){expect(m.match(/\$[$1-9]/),"Unescaped $ found in localized string.");return m==="$$"?"$":varArgs[m[1]]}))}getBoolean(id){const value=this.getValue(id);expectIsType(id,value,"boolean");return value}getInteger(id){const value=this.getValue(id);expectIsType(id,value,"number");expect(value===Math.floor(value),"Number isn't integer: "+value);return value}overrideValues(replacements){expect(typeof replacements==="object","Replacements must be a dictionary object.");for(const key in replacements){this.data_[key]=replacements[key]}}}function expect(condition,message){if(!condition){throw new Error("Unexpected condition on "+document.location.href+": "+message)}}function expectIsType(id,value,type){expect(typeof value===type,"["+value+"] ("+id+") is not a "+type)}expect(!loadTimeData,"should only include this file once");loadTimeData=new LoadTimeData;window.loadTimeData=loadTimeData;console.warn("crbug/1173575, non-JS module files deprecated.");</script><script jstcache="0">const pageData = {"details":"Details","errorCode":"ERR_CONNECTION_TIMED_OUT","fontfamily":"'Segoe UI', Tahoma, sans-serif","fontfamilyMd":"'Segoe UI', Tahoma, sans-serif","fontsize":"75%","heading":{"hostName":"www.googleadservices.com","msg":"This site can’t be reached"},"hideDetails":"Hide details","iconClass":"icon-generic","language":"en","reloadButton":{"msg":"Reload","reloadUrl":"https://www.googleadservices.com/pagead/aclk?sa=L&ai=CSHSL-q9uZaW8Neuj7OsPjL2kiAn_vpKsdLacoL_TD774_o4DCAAQASDJmKILKAJg4dy5BaABlvTLmQPIAQGpAuejGO2JL7I-yAPYIKoEXE_QO_ZhIPcsKIf6h1nOPwCaHyaKdvtrr8lUqmA_hTXWkx58ga1WlFD_B5S0XIi0ARRB-NMRzpEjWYl_Ub6Q8cK4wz4yokqAT1tvSbmcvk5zyNksHwGYAPxm6lHpwASLisrhiwKABZBOiAWJj5fNB6AGZoAH776tggGQBwGoB-u4sQKoB6a-G6gHvK2xAqgHuauxAqgHuZqxAqgH89EbqAfu0huoB_-csQKoB8rcG6gHkq-xAqgHu6SxAqgHkqaxAqgH2LOxAqgH2KaxAqgHyqmxAqgHmbWxAqgH3rWxAqgH26qxAqgH0KqxAqgH3LCxAqgHv7mxAqgH6rGxAqgHqrixAqgHlLixAqgH7LixAqgHvrexAqAIt7KpBLAIAdIIIBABMgOH4AI6BMBAgkBCAQFI0ezzKlAJWKWh96XD94IDmgkZaHR0cHM6Ly93d3cuaG9zdGluZ2VyLnBoL7EJGsz1RA6pVca5Ccu6GugJDqJQ-AkBmAsB2gwQCgoQ8LPF5_XKipgsEgIBA-gMBqoNAlBIuA0ByA0BghQNCAMSCWhvc3RpbmdlcogUA8gU2aDpiZjcnN9V0BUBmBYB-BYBgBcBkhcJEgcIARADGJICuhcCOAHgFwI&ase=2&gclid=EAIaIQobChMIpaH3pcP3ggMV6xF7Bx2MHgmREAAYASAAEgK75PD_BwE&nis=6&ved=2ahUKEwi2rfKlw_eCAxVIeXAKHV3gAtYQ0Qx6BAgFEAE&cid=CAASFORoyXznCn95cxqnY-7EcwIzpAmd&dblrd=1&val=Ggist4lgRmi6zyABKAAwwIrRy6D7pZ7VATj637qrBkD637qrBg&sig=AOD64_0BBXw1jjwuynxQZdc0-BNLP_nxpA&adurl=https://www.hostinger.ph/%3Fppc_campaign%3Dgoogle_search_brand%26bidkw%3Dhostinger%26gad_source%3D1"},"suggestionsDetails":[{"body":"Check any cables and reboot any routers, modems, or other network\n    devices you may be using.","header":"Check your Internet connection"},{"body":"If it is already listed as a program allowed to access the network, try\n      removing it from the list and adding it again.","header":"Allow Chrome to access the network in your firewall or antivirus\n          settings."},{"advancedTitle":"Show advanced settings…","body":"Check your proxy settings or contact your network administrator to\n      make sure the proxy server is working. If you don't believe you should\n      be using a proxy server:\n      Go to\n          the Chrome menu >\n          \u003Cspan jscontent=\"settingsTitle\">\u003C/span>\n          >\n          \u003Cspan jscontent=\"advancedTitle\">\u003C/span>\n          >\n          \u003Cspan jscontent=\"proxyTitle\">\u003C/span>\n          >\n          LAN Settings\n          and deselect \"Use a proxy server for your LAN\".","header":"If you use a proxy server…","proxyTitle":"Change proxy settings…","settingsTitle":"Settings"}],"suggestionsSummaryList":[{"summary":"Checking the connection"},{"summary":"\u003Ca href=\"#buttons\" onclick=\"toggleHelpBox()\">Checking the proxy and the firewall\u003C/a>"}],"suggestionsSummaryListHeader":"Try:","summary":{"failedUrl":"https://www.googleadservices.com/pagead/aclk?sa=L&ai=CSHSL-q9uZaW8Neuj7OsPjL2kiAn_vpKsdLacoL_TD774_o4DCAAQASDJmKILKAJg4dy5BaABlvTLmQPIAQGpAuejGO2JL7I-yAPYIKoEXE_QO_ZhIPcsKIf6h1nOPwCaHyaKdvtrr8lUqmA_hTXWkx58ga1WlFD_B5S0XIi0ARRB-NMRzpEjWYl_Ub6Q8cK4wz4yokqAT1tvSbmcvk5zyNksHwGYAPxm6lHpwASLisrhiwKABZBOiAWJj5fNB6AGZoAH776tggGQBwGoB-u4sQKoB6a-G6gHvK2xAqgHuauxAqgHuZqxAqgH89EbqAfu0huoB_-csQKoB8rcG6gHkq-xAqgHu6SxAqgHkqaxAqgH2LOxAqgH2KaxAqgHyqmxAqgHmbWxAqgH3rWxAqgH26qxAqgH0KqxAqgH3LCxAqgHv7mxAqgH6rGxAqgHqrixAqgHlLixAqgH7LixAqgHvrexAqAIt7KpBLAIAdIIIBABMgOH4AI6BMBAgkBCAQFI0ezzKlAJWKWh96XD94IDmgkZaHR0cHM6Ly93d3cuaG9zdGluZ2VyLnBoL7EJGsz1RA6pVca5Ccu6GugJDqJQ-AkBmAsB2gwQCgoQ8LPF5_XKipgsEgIBA-gMBqoNAlBIuA0ByA0BghQNCAMSCWhvc3RpbmdlcogUA8gU2aDpiZjcnN9V0BUBmBYB-BYBgBcBkhcJEgcIARADGJICuhcCOAHgFwI&ase=2&gclid=EAIaIQobChMIpaH3pcP3ggMV6xF7Bx2MHgmREAAYASAAEgK75PD_BwE&nis=6&ved=2ahUKEwi2rfKlw_eCAxVIeXAKHV3gAtYQ0Qx6BAgFEAE&cid=CAASFORoyXznCn95cxqnY-7EcwIzpAmd&dblrd=1&val=Ggist4lgRmi6zyABKAAwwIrRy6D7pZ7VATj637qrBkD637qrBg&sig=AOD64_0BBXw1jjwuynxQZdc0-BNLP_nxpA&adurl=https://www.hostinger.ph/%3Fppc_campaign%3Dgoogle_search_brand%26bidkw%3Dhostinger%26gad_source%3D1","hostName":"www.googleadservices.com","msg":"\u003Cstrong jscontent=\"hostName\">\u003C/strong> took too long to respond."},"textdirection":"ltr","title":"www.googleadservices.com"};loadTimeData.data = pageData;var tp = document.getElementById('t');jstProcess(new JsEvalContext(pageData), tp);</script></body></html>